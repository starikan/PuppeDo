...
class Log {
    ...
    bindData(data = {}) {
        if (_.isObject(data)) {
            this.binded = Object.assign(Object.assign({}, this.binded), data);
        }
    }
    ...
    makeLog({ level = 'sane', levelIndent = 0, text = '', now = dayjs(), funcFile = null, testFile = null, extendInfo = false, screenshots = [], error = {}, } = {}) {
    ...
    log({ funcFile, testFile, text = '', screenshot = null, fullpage = null, level = 'info', element = false, testStruct = null, levelIndent = 0, error = {}, testSource = this.binded.testSource, bindedData = this.binded.bindedData, extendInfo = false, stdOut = true, } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const { PPD_DEBUG_MODE, PPD_LOG_DISABLED, PPD_LOG_LEVEL_NESTED, PPD_LOG_SCREENSHOT, PPD_LOG_FULLPAGE, } = new Arguments();
            ...
            try {
                ...
                const screenshots = isScreenshot ? yield this.screenshot.getScreenshots(element, isFullpage, extendInfo) : [];
                const now = dayjs();
